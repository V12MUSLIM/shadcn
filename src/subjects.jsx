    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4 pt-8">
          ...
          <p className="text-xl text-slate-400">Pick a subject to view its chapters</p>
        </div>
                ...
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <div
                      ...
                      style={{ backgroundColor: `${subject.color}15`, borderColor: `${subject.color}30` }}
                    >
                      <Icon style={{ color: subject.color }} className="w-7 h-7" />
                    </div>
                    <div>
                      <CardTitle className="text-white text-2xl">{subject.title}</CardTitle>
                      <CardDescription className="text-slate-400">{subject.description}</CardDescription>
                    </div>
                  </div>
                </CardHeader>
